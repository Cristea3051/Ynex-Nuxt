                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <button class="btn btn-primary btn-sm btn-wave" data-bs-toggle="modal"
                            data-bs-target="#create-contact"><i
                                class="ri-add-line me-1 fw-semibold align-middle"></i>Add
                            Company</button>
                        <button class="btn btn-success-light btn-sm btn-wave">Export As CSV</button>
                        <div class="dropdown">
                            <a href="javascript:void(0);" class="btn btn-light btn-sm btn-wave"
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="(item, key) in companies" :key="key" class="crm-contact">
                                    <td>
                                        <input @click="checkFn" ref="checkOption" class="form-check-input"
