...
export default {
    ...
    data() {
        return {
            ...
            candidatesListData: [
                {
                    image: faces1, name: 'Brenda Simpson ', role: 'Software Developer', location: 'Kondapur, Hyderabad', rating: '4.5', review: '142', mort: 'Graduate', moon: 'flexible-shift', clock: 'Immediate Joinee', broadcast: 'Good at English', packageFrom: '$2,300', packageTo: '$4,678', languages: ['English, Hindi, Telugu'], skills: ['HTML', 'CSS', 'Javascript', 'Angular'],
                    bondAccept: '1', experience: '2 Years'
                },
                {
                    image: faces3, name: 'Dwayne Stort ', role: 'Web Developer', location: 'Gachibowli, Hyderabad', rating: '3', review: '35', mort: 'Post Graduate', moon: 'flexible-shift', clock: 'Within 10 Days', broadcast: 'Good at English', packageFrom: '$3,600 ', packageTo: '$4,700', languages: ['English, Telugu'], skills: ['Javascript', 'React', 'React Native', 'HTML'],
                    bondAccept: '2', experience: '4 Years'
                },
                {
                    image: faces21, name: 'Jasmine Kova ', role: 'Python Developer', location: 'Gachibowli, Chennai', rating: '3', review: '56', mort: 'MBA', moon: 'Day-shift', clock: 'Within 30 Days', broadcast: 'Avg at English', packageFrom: '$4,300 ', packageTo: '$5,000', languages: ['English, Telugu'], skills: ['Python', 'Java', 'React', 'Angular'],
                    bondAccept: '0', experience: '5 Years'
                },
                {
                    image: faces5, name: 'Kiara Advain ', role: 'Java Developer', location: 'Gachibowli, Banglore', rating: '3', review: '13', mort: 'MBA',
                    moon: 'Day-shift', clock: 'Within 30 Days', broadcast: 'Good at English', packageFrom: '$3,678', packageTo: '$5,678', languages: ['English, Hindi, Telugu'], skills: ['Java', 'Core Java'],
                    bondAccept: '2', experience: 'Fresher'
                },
                {
                    image: faces13, name: 'Json Taylor ', role: 'Angular Developer', location: 'Gachibowli, Nellore', rating: '4', review: '18', mort: 'MBA', moon: 'flexible-shift', clock: 'Within 15 Days', broadcast: 'Fluent at English', packageFrom: '$3,600', packageTo: '$4,700', languages: ['English, Hindi, Telugu'], skills: ['Java', 'Advanced Java', 'Angular', 'HTML'],
                    bondAccept: '2', experience: '5 Years'
                },
                {
                    image: faces21, name: 'Diego Sanch ', role: 'AWS Developer', location: 'Kukatpally, Hyderabad', rating: '3', review: '13', mort: 'MBA',
                    moon: 'Day-shift', clock: 'Within 30 Days', broadcast: 'Good at English', packageFrom: '$8,900', packageTo: '$10,900', languages: ['English, Hindi, Telugu'], skills: ['AWS Lambda', 'Athena', 'Linux', 'Angular'],
