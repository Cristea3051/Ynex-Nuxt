                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="flex-fill">
                                                                    ...
                                                                    <p class="mb-0">
                                                                        <span class="badge bg-success">{{ row.likes }}<i
                            ...
                            <div class="row gx-5">
                                <div class="col-xl-12 mt-xxl-0 mt-3">
                                    <div>
                                        ...
                                        <p class="fs-18 mb-4">
                                            <i class="ri-heart-3-fill text-danger align-middle"></i> <span
                                                class="fw-semibold text-muted"><a class="text-info fs-14"
                                                        ...
                                                        <div class="d-sm-flex d-block align-items-top mb-3">
                                                            <div class="d-flex flex-fill">
                                                                ...
                                                                <div class="lh-1 me-2">
                                                                    ...
                                                                    <div class="mb-1">
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-fill align-middle text-warning align-middle fs-12 me-1"></i>
                                                                        <i
                                                                            class="ri-star-line text-warning align-middle fs-12 me-1"></i>
                                                                    </div>
