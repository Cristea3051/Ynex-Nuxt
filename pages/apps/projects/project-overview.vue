...
export default {
    ...
    data() {
        return {
            ...
            ProjectDocuments: [
                { name: "Full Project", size: "0.45MB", avatar: filemanager1, class: 'p-2' },
                { name: "assets.zip", size: "0.99MB", avatar: filemanager3, class: '' },
                { name: "image-1.png", size: "245KB", avatar: filemanager1, class: 'p-2' },
                { name: "documentation.zip", size: "2MB", avatar: filemanager3, class: '' },
                { name: "landing.zip", size: "3.46MB", avatar: filemanager3, class: '' },
            ]
...
<template>
    ...
    <div class="row">
        ...
        <div class="col-xl-3">
            <SimpleCardComponent title="Project Team" cardHeaderClass="justify-content-between"
                ...
                <TableComponent :headers="['Name', 'Designation', 'Actions']" :rows="projectTeam"
                    tableClass="table text-nowrap projects-overview-table" v-slot:cell="{ row }">
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="me-2 lh-1">
                                <span class="avatar avatar-sm avatar-rounded">
                    ...
                    <td>
                        <div class="btn-list">
                            <button class="btn btn-sm btn-icon btn-info-light btn-wave waves-effect waves-light"><i
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item" v-for="(card, index) in ProjectDocuments" :key="index">
                        <div class="d-flex align-items-center flex-wrap gap-2">
                            <div class="lh-1">
                                <span :class="`avatar avatar-rounded ${card.class} bg-light`">
