...
<template>
            ...
            <SimpleCardComponent title="Tab Style-4">
                <nav>
                    <div class="nav nav-tabs nav-justified tab-style-4 d-flex" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link text-nowrap" id="nav-contact-tab" data-bs-toggle="tab"
            ...
            <SimpleCardComponent title="Tab Style-6">
                ...
                <div class="tab-content" id="myTabContent2">
                    <div class="tab-pane fade show active p-0 border-bottom-0" id="products-tab-pane" role="tabpanel"
                        ...
                        <TableComponent :headers="['Product', 'Name', 'Category', 'Price']" :rows="tanStyle"
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <SimpleCardComponent title=" Pills with dropdowns">
