...
export default {
  ...
  methods: {
    ...
    if (!this.isFullscreen) {
        if ((card as any).requestFullscreen) {
            (card as any).requestFullscreen();
        } else if ((card as any).mozRequestFullScreen) { // Firefox
            (card as any).mozRequestFullScreen();
        } else if ((card as any).webkitRequestFullscreen) { // Safari and Chrome
            (card as any).webkitRequestFullscreen();
        } else if ((card as any).msRequestFullscreen) { // IE/Edge
        ...
        } else if (document.webkitExitFullscreen) { // Safari and Chrome
            ...
            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                ...
                <SimpleCardComponent :showCardHeader="false" :showCardFooter="true">
                  <template v-slot:default>
                      ...
                      <p class="card-text">
                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration many variations of passages of Lorem Ipsum available. There are so many ways to solve but the majority have suffered.
                      </p>
                  </template>
            ...
            <div class="col-xl-2" v-for="(card,index) in cardData.Nature" :key="index" >
                <BasicCardComponent cardClass="custom-card" :showCardBody="true">
                    <template v-slot:cardBody>
                        ...
                        <h6 class="card-title fw-semibold mb-3">{{ card.title }}<span :class="`badge bg-${card.badgeColor} float-end fs-10 text-dark`">{{ card.badgeText }}</span></h6>
                        <p class="card-text">{{ card.content }}</p>
                    </template>
                </BasicCardComponent>
            </div>
            <div class="col-xl-3">
                <SimpleCardComponent customCardClass="text-center" title="Featured" :showCardFooter="true" cardFooterClass="text-muted">
                    ...
                    <div class="col-xxl-7 col-xl-12">
                        <BasicCardComponent cardClass="custom-card" v-slot:card>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-4">
                                    <img src="/images/media/media-39.jpg" class="img-fluid rounded-sm-end rounded-bottom h-100 w-100" alt="...">
                                </div>
                            </div>
                        </BasicCardComponent>
                    </div>
