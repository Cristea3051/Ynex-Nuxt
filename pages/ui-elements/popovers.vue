            ...
            <showcodeCard title="Colored Popovers" :code="prism.coloredPopovers">
                <div class="btn-list">
                    ...
                    <button type="button" class="btn btn-secondary btn-wave" data-bs-toggle="popover"
                        data-bs-placement="left" data-bs-custom-class="popover-secondary" title="Color Background"
                    ...
                    <button type="button" class="btn btn-warning btn-wave" data-bs-toggle="popover"
                        data-bs-placement="right" data-bs-custom-class="popover-warning" title="Color Background"
                    ...
                    <button type="button" class="btn btn-danger btn-wave" data-bs-toggle="popover"
                        data-bs-placement="left" data-bs-custom-class="popover-danger" title="Color Background"
                    ...
                    <button type="button" class="btn btn-purple btn-wave" data-bs-toggle="popover"
                        data-bs-placement="right" data-bs-custom-class="popover-purple" title="Color Background"
