...
export default {
    ...
    mounted() {
        // const popover = new (window.bootstrap).Popover(document.body, {
...
<template>
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <showcodeCard :code="prism.whiteVariant" title="White variant" custom-card-body-class="bg-black rounded-b">
