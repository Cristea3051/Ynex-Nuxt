...
export default {
    ...
    data() {
        return {
            ...
            currentTabIndex: 0,
            tabs: [
        { title: 'Registration',currentTabIndex: 0, },
        { title: 'Email',currentTabIndex: 1, },
        { title: 'Birth Date',currentTabIndex: 2, }
      ]
        };
    },
    methods: {
...
<template>
    ...
    <div class="row">
      ...
      @submit.prevent="onSubmit">
                    <div class="col-xs-12"  v-for="(tab, index) in tabs" :key="index">
                        <div 
      :class="{
        'tab-content': true, 
