...
<template>
    ...
    <div class="row">
        <div class="col-xl-3">
            <div class="card custom-card" :code="prism.defaultStyling">
        ...
        <div class="col-xl-3">
            <div class="card custom-card" :code="prism.limitDistanceBetweenSliders">
                <div class="card-header justify-content-between">
                    <div class="card-title">
        ...
        <div class="col-xl-3">
            <div class="card custom-card" :code="prism.slideWithCustomTooltip">
                <div class="card-header justify-content-between">
                    <div class="card-title">
        ...
        <div class="col-xl-3">
            <div class="card custom-card" :code="prism.squareStyling">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Square Styling
                    </div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="col-xl-12">
                <div class="card custom-card" :code="prism.syncMultiComponentSliders">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
            ...
            <div class="col-xl-12">
                <div class="card custom-card" :code="prism.labelSlot">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            Label slot
                        </div>
        ...
        <div class="col-xl-6">
            <div class="col-xl-12">
                <div class="card custom-card" :code="prism.tooltipsSlider">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            tooltips slider
                        </div>
            ...
            <div class="col-xl-12">
                <div class="card custom-card" :code="prism.stepSlot">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            Step slot
                        </div>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card" :code="prism.coloredConnectElements">
                <div class="card-header justify-content-between">
                    <div class="card-title">
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card custom-card" :code="prism.customLabels">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Custom Labels
                    </div>
        ...
        <div class="col-xl-6">
            <div class="card custom-card" :code="prism.independentSlider">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Independent slider
                    </div>
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.primary">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Primary
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.secondary">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Secondary
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.warning">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Warning
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.info">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Info
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.success">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Success
                    </div>
        ...
        <div class="col-xl-4">
            <div class="card custom-card" :code="prism.danger">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Danger
                    </div>
