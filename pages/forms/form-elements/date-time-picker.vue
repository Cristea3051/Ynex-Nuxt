                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            ...
                            <Datepicker class="form-control" autoApply placeholder="Choose date" v-model="picked" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control" autoApply placeholder="Choose date" :lowerLimit="picked"
                                v-model="picked2" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control" autoApply placeholder="Choose date" :upperLimit="picked1"
                                v-model="picked3" />
                        </div>
                    </div>
                </div>
            ...
            <div class="card custom-card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group flex-nowrap input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker class="form-control" autoApply placeholder="Choose date" v-model="picked4"
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="input-group input-group-custom">
                            <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                            <Datepicker autoApply placeholder="Date Time" class="form-control datepicker-here"
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-custom">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <Datepicker placeholder="Date Time" class="form-control datepicker-here" autoApply
                                        v-model="weekPicker" week-picker> <template #input-icon>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-custom">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <Datepicker v-model="quarter" autoApply class="form-control" quarter-picker />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-0">
                                <div class="input-group input-group-custom">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <Datepicker v-model="date1" range multi-calendars autoApply class='form-control' />
                                </div>
                            </div>
                        </div>
                    </div>
