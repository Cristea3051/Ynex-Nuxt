                ...
                <div class="card custom-card">
                    <div class="card-body p-5">
                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mb-2">
                                ...
                                <div class="input-group">
                                    <passwordInput initialValue="" name="password" id="password"
                        ...
                        <div class="text-center">
                            <p class="fs-12 text-muted mt-3 mb-0">Try unlock with different methods <a
                                    class="text-success" href="javascript:void(0);"><u>Finger print</u></a> / <a
                                    class="text-success" href="javascript:void(0);"><u>Face Id</u></a></p>
                        </div>
                    </div>
                </div>
            </div>
