...
<template>
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-12">
                    <SimpleCardComponent title="Vertical alignment"
                        cardClassBody="bd-example-row bd-example-row-flex-cols">
                        <div class="container">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Column wrapping" cardClassBody="bd-example-row">
                        <div class="container">
                            <div class="row">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Margin utilities" cardClassBody="bd-example-row">
        ...
        <div class="col-xl-6">
            <div class="row">
                <div class="col-xl-12">
                    <SimpleCardComponent title="Horizontal alignment" cardClassBody="bd-example-row">
                        <div class="container">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Column breaks" cardClassBody="bd-example-row">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title="Order classes" cardClassBody="bd-example-row">
                        <div class="container">
                            <div class="row mb-3">
                                <div class="col">
                ...
                <div class="col-xl-12">
                    <SimpleCardComponent title=" Standalone column classes">
    ...
    <div class="row">
        <div class="col-xl-12">
            <SimpleCardComponent title="Offset classes" cardClassBody="bd-example-row">
                <div class="container mb-3">
                    <div class="row mb-3">
                        <div class="col-md-4">.col-md-4</div>
    ...
    <div class="row">
        <div class="col-xl-6">
            <SimpleCardComponent :showCardHeader="false">
                <p>The classes can be used together with utilities to create responsive floated images. Make sure to
                    wrap the content in a <span class="text-danger">.clearfix</span> wrapper to clear the float if the
                    text is shorter.</p>
                <div class="clearfix">
