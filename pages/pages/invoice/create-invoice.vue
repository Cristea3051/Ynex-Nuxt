        ...
        <div class="col-xl-9">
            <div class="card custom-card">
                    ...
                    <div class="row gy-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 ms-auto mt-sm-0 mt-3">
                                    ...
                                    <div class="row gy-2">
                                        ...
                                        <div class="col-xl-12 choices-control create-invoice-select">
                        ...
                        <div class="col-xl-3">
                            ...
                            <div class="form-group">
                                <div class="input-group flex-nowrap input-group-custom">
                                    ...
                                    <Datepicker placeholder="Date Time" class="form-control form-control-light"
                        ...
                        <div class="col-xl-12">
                            <div class="table-responsive">
                                <table class="table nowrap text-nowrap border mt-3 invoice-custom">
                                    <thead>
                                        <tr>
                                            <th>PRODUCT NAME</th>
                                            <th>DESCRIPTION</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="invoice-quantity-container text-center">
                                                <div class="input-group border rounded flex-nowrap">
                                                    <quantity placeholder="Quantity" name="first" :initialValue="1" />
                                                </div>
                                            </td>
                                            <td><input class="form-control form-control-light" placeholder=""
                                                    type="text" value="$60.00"></td>
                                            <td><input class="form-control form-control-light" placeholder=""
                                                    type="text" value="$120.00"></td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="invoice-quantity-container">
                                                <div class="input-group border text-center rounded flex-nowrap">
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-light me-1"><i class="ri-eye-line me-1 align-middle"></i>Preview</button>
