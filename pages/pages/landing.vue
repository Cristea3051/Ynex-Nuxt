...
import ReviewsCardComponent from "@/components/@spk/pages/reviews-cards.vue";
import OurteamCardComponent from "@/components/@spk/pages/landing-ourteam-cards.vue";
import LandingPriceComponent from '@/components/@spk/pages/landing-pricing-cards.vue';
import SwiperjsCardComponent from "@/components/@spk/swiperjs-cards.vue";
import * as landingData from "@/data/pages/landing.js";
                ...
                <div class="header-content-left">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <NuxtLink to="/dashboard/crm" class="header-logo">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element align-items-center">
                        ...
                        <div class="btn-list d-lg-none d-block">
                            ...
                            <button class="btn btn-icon btn-success switcher-icon lh-sm" data-bs-toggle="offcanvas"
                    ...
                    <nav class="main-menu-container nav nav-pills sub-open">
                        ...
                        <div class="d-lg-flex d-none">
                            <div class="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                ...
                                <button class="btn btn-wave btn-icon btn-light switcher-icon lh-sm"
                        ...
                        <div class="row">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                <div class="py-lg-5">
                                    ...
                                    <NuxtLink to='/dashboard/crm' class="m-1 btn btn-primary">
                                        View Demos
            ...
            <section class="section landing-testimonials section-bg" id="testimonials">
                <div class="container text-center">
                    ...
                    <swiper :navigation="false" :pagination="{
                        dynamicBullets: true
                    }" :modules="modules" class=" pagination-dynamic text-start" :breakpoints="{
                        '0': {
                            slidesPerView: 1,
                            spaceBetween: 20,
                        },
                            ...
                            <div class="row gy-2">
                                <div class="col-xl-6">
                                    <div class="accordion accordion-customicon1 accordion-primary" id="accordionFAQ1">
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingcustomgeneral">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapsecustomgeneral"
                                                    aria-expanded="false" aria-controls="collapsecustomgeneral">
                                                    General Terms & Conditions (GTC)
                                                </button>
                                            </h2>
                                            <div id="collapsecustomgeneral" class="accordion-collapse collapse"
                                                aria-labelledby="headingcustomgeneral" data-bs-parent="#accordionFAQ1">
                                                <div class="accordion-body">
                                                    <strong>This is the first item's accordion body.</strong> It is
                                                    shown by
                                                    default, until the collapse plugin adds the appropriate classes that
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingcustomaccount">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapsecustomaccount"
                                                    aria-expanded="false" aria-controls="collapsecustomaccount">
                                                    Do I need to create an account to make an order?
                                                </button>
                                            </h2>
                                            <div id="collapsecustomaccount" class="accordion-collapse collapse"
                                                aria-labelledby="headingcustomaccount" data-bs-parent="#accordionFAQ1">
                                                <div class="accordion-body">
                                                    <strong>This is the first item's accordion body.</strong> It is
                                                    shown by
                                                    default, until the collapse plugin adds the appropriate classes that
                                ...
                                <div class="col-xl-6">
                                    <div class="accordion accordion-customicon1 accordion-primary" id="accordionFAQ3">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapsecustomicon3Two" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingcustomhours">
                                                <button class="accordion-button collapsed" type="button"
                                                    data-bs-toggle="collapse" data-bs-target="#collapsecustomhours"
                                                    aria-expanded="true" aria-controls="collapsecustomhours">
                                                    What are your opening hours?
                                                </button>
                                            </h2>
                                            <div id="collapsecustomhours" class="accordion-collapse collapse"
                                                aria-labelledby="headingcustomhours" data-bs-parent="#accordionFAQ3">
                                                <div class="accordion-body">
                                                    <strong>This is the first item's accordion body.</strong> It is
                                                    shown by
                                                    default, until the collapse plugin adds the appropriate classes that
                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingcustomitem">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapsecustomitem" aria-expanded="true"
                                                    aria-controls="collapsecustomitem">
                                                    Do I have the right to return an item?
                                                </button>
                                            </h2>
                                            <div id="collapsecustomitem" class="accordion-collapse"
                                                aria-labelledby="headingcustomitem" data-bs-parent="#accordionFAQ3">
                                                <div class="accordion-body">
                                                    <strong>This is the first item's accordion body.</strong> It is
                                                    shown by
                                                    default, until the collapse plugin adds the appropriate classes that
                        ...
                        <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                            <div class="px-4">
                                ...
                                <p class="mb-2 op-6 fw-normal">
                                    ...
                                    fuga
                                    est
                                    mollitia eius, quo illum illo inventore optio aut quas omnis rem. Dolores
                                    accusantium
                                    aspernatur
                                    minus ea incidunt.
                                </p>
