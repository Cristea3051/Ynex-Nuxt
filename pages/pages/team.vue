...
export default {
    ...
    data() {
        return {
            ...
            { id: 8, color: "fixed-white", name: "Paul Rudd", email: "paulrudd143@gmail.com", since: "7 Months", projects: "17", position: "Member", coverImg: cover8, src: face15, socialMedia :[ 
                        {name:"facebook", links:"", icon:"facebook", iconColor:"primary"},
                        {name:"twitter", links:"", icon:"twitter-x", iconColor:"secondary"},
                        {name:"instagram", links:"", icon:"instagram", iconColor:"warning"},
                        {name:"github", links:"", icon:"github", iconColor:"success"},
            ...
            <div class="team-members" id="team-members">
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-12" v-for="card in teams" :key="card.id">
                        <TeamsCardComponent customCardClass="team-member-card"  coverSrcClass="card-img-top" 
                        :card="card"
                        starIcon="ri-star-fill fs-16" cardBodyClass="p-0"
                        :showDropdown=true cardFooterClass="border-block-start-dashed text-center" />
