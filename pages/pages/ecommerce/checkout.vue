...
export default {
    ...
    data() {
        return {
            ...
            citySelecteValue: { name: 'Georgetown', language: 'Georgetown' },
            citySelecteOptions: [
                { name: 'Georgetown', language: 'Georgetown' },
                { name: 'Alexandria', language: 'Alexandria' },
                { name: 'Rockville', language: 'Rockville' },
                { name: 'Frederick', language: 'Frederick' },
            ],
            stateSelecteValue: { name: 'Washington,D.C', language: 'Washington,D.C' },
            stateSelecteOptions: [
                { name: 'Washington,D.C', language: 'Washington,D.C' },
                { name: 'California', language: 'California' },
                { name: 'Texas', language: 'Texas' },
                { name: 'Alaska', language: 'Alaska' },
            ],
        };
    },
    methods: {
                            ...
                            <li class="nav-item" role="presentation">
                                <button ref="payment" class="nav-link" id="shipped-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="shipped-tab" aria-selected="false"><i
                                        class="ri-bank-card-line me-2"></i>Payment</button>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <div class="tab-content" id="myTabContent">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row gy-3">
                                                                ...
                                                                <div class="col-xl-6">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="address-new" placeholder="Address">
                                                                </div>
                                                                <div class="col-xl-12">
                                                                    <div class="row">
                                                                        <div class="col-xl-3">
                                    ...
                                    <div class="row gy-4 mb-4">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row gy-2">
                                                <div class="col-xl-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control is-valid"
                                                            id="pincode-add" value="20071" placeholder="Name">
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="country-add"
                                                            value="USA" placeholder="Name">
                                                ...
                                                <div class="form-check-label">
                                                    <div class="d-sm-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="shipping-partner-details me-sm-5 me-0">
                                                            ...
                                                            <p class="text-muted fs-11 mb-0">Delivered By 24,Nov 2022
                                                            </p>
                                                        </div>
                                                ...
                                                <div class="form-check-label">
                                                    <div class="d-sm-flex align-items-center justify-content-between">
                                                        ...
                                                        <div class="shipping-partner-details me-sm-5 me-0">
                                                            ...
                                                            <p class="text-muted fs-11 mb-0">Delivered By 22,Nov 2022
                                                            </p>
                                                        </div>
                                                        <div class="fw-semibold me-sm-5 me-0">
                                                            $10.49
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-xxl-4">
                                            ...
                                            <VueMultiselect :searchable="true" :show-labels="false"
                                                v-model="citySelecteValue" :options="citySelecteOptions"
                                        ...
                                        <div class="col-xxl-4">
                                            ...
                                            <VueMultiselect :searchable="true" :show-labels="false"
                                                v-model="stateSelecteValue" :options="stateSelecteOptions"
                                                 placeholder="Select one" label="name"
                                                track-by="name">
                                            </VueMultiselect>
                                        </div>
                                                    ...
                                                    <div class="row gy-3">
                                                        <div class="col-xl-12">
                                                            <label for="payment-card-number" class="form-label">Card
                                                                Number</label>
                                                            <input type="text" class="form-control"
                                                                id="payment-card-number" placeholder="Card Number"
                                                        ...
                                                        <div class="col-xl-12">
                                                            <label for="payment-card-name" class="form-label">Name On
                                                                Card</label>
                                                            <input type="text" class="form-control"
                                                                id="payment-card-name" placeholder="Name On Card"
                                                                value="JSON TAYLOR">
                                                        </div>
                                                        <div class="col-xl-4">
                                                        ...
                                                        <div class="col-xl-4">
                                                            ...
                                                            <label for="payment-security"
                                                                class="form-label mt-1 text-success fs-11"><sup><i
                                                                        class="ri-star-s-fill"></i></sup>Do not share
                                                                O.T.P
                                                                with anyone</label>
                                                        </div>
                                                        <div class="col-xl-12">
                                                            <div class="form-check">
                                                                <input class="form-check-input form-checked-success"
                                                                    type="checkbox" value="" id="payment-card-save"
                                                                    checked>
                            ...
                            <div class="tab-pane fade border-0 p-0" id="delivery-tab-pane" role="tabpanel"
                                ...
                                <div class="p-5 checkout-payment-success my-3">
                                    ...
                                    <div class="mb-4">
                                        <p class="mb-1 fs-14">You can track your order with Order Id <b>SPK#1FR</b> from
                                            <a class="link-success" href="javascript:void(0);"><u>Track Order</u></a>
                                        </p>
