...
export default {
    ...
    data() {
        return {
            ...
            mailItems: [
                ...
                { id: 2, avatar: face12, sender: 'Michael Jeremy', liClass: "active", time: '10:27AM', subject: 'History of planets are discovered yesterday.', text: "gray", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: true },
                { id: 3, avatar: face14, badge: "Promotion", badgeColor: "success", sender: 'King Berunda', time: 'Yesterday, 10:27AM', text: "gray", subject: 'Request for return of item?', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 4, avatar: face7, badge: "Social", badgeColor: "primary", sender: 'Samantha May', time: '24 Oct, 5:45PM', text: "gray", subject: 'Completion of work is pending', snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: true },
                ...
                { id: 7, avatar: face3, sender: 'Kiara Jah', time: '08 Aug, 08:12AM', subject: 'Applying for bank loan?', text: "gray", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
                { id: 8, avatar: face13, sender: 'David Subhman', time: '16 July, 05:52PM', subject: 'Life Insurance Corporation.', text: "gray", snippet: 'Lorem ipsum dolor sit amet consectetur adipisicing elit', cheacked: false },
            ],
            mainImgSrc: {
                avatar: face12,
            ...
            recipients: [
                ...
                { name: 'Mounika', image: face3, status: 'offline' }
            ],
            navSections: [
                {
                    title: 'MAILS',
            ...
            tagValue: [
                { name: 'jay@gmail.com', code: 'jay@gmail.com' }
            ],
            tagOptions: [
                { name: 'kimo@gmail.com', code: 'kimo@gmail.com' },
                { name: 'don@gmail.com', code: 'don@gmail.com' },
                { name: 'kia@gmail.com', code: 'kia@gmail.com' },
                { name: 'jay@gmail.com', code: 'jay@gmail.com' },
            ],
        };
    },
    methods: {
        ...
        responsiveMaiView() {
            ...
            if (this.WindowPreSize.length > 1) {
                if (
                    ...
                    // Cast the ref to HTMLElement type to access classList
                    const mailNavigation = this.$refs['mail-navigation'] as HTMLElement;
                    if (mailNavigation) {
                ...
                if (
                    ...
                    // Ensure the refs are correctly typed as HTMLElement
                    const totalMails = this.$refs['total-mails'] as HTMLElement | null;
                    const mailNavigation = this.$refs['mail-navigation'] as HTMLElement | null;
                    const mailsInformation = this.$refs['mails-information'] as HTMLElement | null;

                    // Check if the refs exist before attempting to access classList
                    if (totalMails) totalMails.classList.remove('d-none');
                    if (mailNavigation) mailNavigation.classList.remove('d-none');
                    if (mailsInformation) mailsInformation.classList.remove('d-block');
                }
            }
        },
        totalmailscloseFn() {
            if (window.innerWidth <= 992) {
                // Type assertion to tell TypeScript that $refs are HTMLElement or null
                const totalMails = this.$refs['total-mails'] as HTMLElement | null;
                const mailNavigation = this.$refs['mail-navigation'] as HTMLElement | null;

                // Check if the refs are defined before attempting to modify their classList
                if (totalMails) totalMails.classList.add('d-none');
                if (mailNavigation) mailNavigation.classList.remove('d-none');
            }
        },
        ...
        showMessages() {
            if (window.innerWidth <= 992) {
                // Type assertion to ensure TypeScript knows these are DOM elements
                const totalMails = this.$refs['total-mails'] as HTMLElement | null;
                const mailNavigation = this.$refs['mail-navigation'] as HTMLElement | null;

                // Check if the elements exist before accessing classList
                if (totalMails) totalMails.classList.remove('d-none');
                if (mailNavigation) mailNavigation.classList.add('d-none');
            }
        },

        showMailDetail() {
            if (window.innerWidth <= 1399) {
                // Type assertion to tell TypeScript the refs are DOM elements
                const totalMails = this.$refs['total-mails'] as HTMLElement | null;
                const mailsInformation = this.$refs['mails-information'] as HTMLElement | null;

                // Check if the refs exist before accessing their classList
                if (totalMails) totalMails.classList.add('d-none');
                if (mailsInformation) mailsInformation.classList.add('d-block');
            }
        },
    ...
    mounted() {
        ...
        if (window.innerWidth >= 992) {
            ...
            // Check if refs are not null before modifying classList
            if (totalMails) totalMails.classList.remove('d-none');
            if (mailNavigation) mailNavigation.classList.remove('d-none');
        } else {
            // Type assertion to tell TypeScript that refs are HTMLElement or null
            ...
            // Check if mailNavigation exists before modifying classList
            if (mailNavigation) mailNavigation.classList.add('d-none');
        }
                        ...
                        <div @click="showMailDetail" class="d-flex align-items-top">
                            <div class="me-3 mt-1">
                                <input class="form-check-input" type="checkbox" id="checkboxNoLabel1" value=""
                                    aria-label="..." :checked="mailapp.cheacked" </div>
                                <div class="me-1 lh-1">
                                ...
                                <div class="flex-fill">
                                    ...
                                    <p class="mail-msg mb-0">
                                        <span class="d-block mb-0 fw-semibold text-truncate">{{ mailapp.subject
                                        }}</span>
                ...
                <div class="mail-info-body p-4" id="mail-info-body">
                    ...
                    <div class="mail-attachments mb-4">
                        ...
                        <div class="mt-2 d-flex flex-wrap">
                            ...
                            <a href="javascript:void(0);" class="btn btn-icon btn-outline-light ms-2 btn-lg mb-1 lh-sm"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Image_012.jpeg">
                                <i class="ri-attachment-2 align-top"></i>
                            </a>
                        </div>
                    </div>
                    <div class="mb-3">
        ...
        <div class="mail-recepients border">
            ...
            <PerfectScrollbar class="p-3 d-flex flex-column align-items-center total-mail-recepients"
                ...
                <a href="javascript:void(0);" class="mail-recepeint-person" v-for="(recipient, index) in recipients"
                    :key="index" data-bs-toggle="tooltip" data-bs-placement="left" :title="recipient.name">
