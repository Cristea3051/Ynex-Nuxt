...
export default {
    ...
    data() {
        return {
            ...
            activitys: [
                { id: 1, avatar: "E", img: "", description: "<p class='mb-2'> <b>You</b> Commented on <b>Work Process</b> in this task <a class='text-secondary' href='javascript:void(0);'><u>#New Task</u></a>.<span class='float-end fs-11 text-muted'>24,Dec 2023 - 14:34</span> </p> <p class='text-muted mb-0'> Task is important and need to be completed on time to meet company work flow. </p>", media: [], avatarList: [], avatarColor: 'primary' },
                { id: 2, avatar: "", img: face11, description: "<p class='text-muted mb-2'><span class='text-default'><b>Json Smith</b> reacted to the task &#128077;</span>.<span class='float-end fs-11 text-muted'>18,Dec 2022 - 12:16</span></p><p class='text-muted mb-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit.  Repudiandae, repellendus rem rerum excepturi aperiam ipsam temporibus inventore ullam tempora eligendi libero sequi dignissimos cumque, et a sint tenetur consequatur omnis!</p>", media: [], avatarList: [], avatarColor: '' },
                { id: 3, avatar: "", img: face4, description: "<p class='text-muted mb-2'><span class='text-default'><b>Alicia Keys</b> shared a document with <b>you</b></span>.<span class='float-end fs-11 text-muted'>21,Dec 2022 - 15:32</span></p>", media: [{ img: filemanager3, name: filemanager3, Size: true }], avatarList: [], avatarColor: '' },
                { id: 4, avatar: "P", img: "", description: "<p class='text-muted mb-2'><span class='text-default'><b>You</b> shared a post with 4 people <b>Simon,Sasha,Anagha,Hishen</b></span>.<span class='float-end fs-11 text-muted'>28,Dec 2022 - 18:46</span></p>", media: [{ img: media18, name: media18 }], avatarList: [{ img: face2, name: face2 }, { img: face8, name: face8 }, { img: face3, name: face3 }, { img: face10, name: face10 }], avatarColor: 'success' },
                { id: 5, avatar: "", img: media39, description: "<p class='mb-1'> <b>Json</b> Commented on Task post <a class='text-secondary' href='javascript:void(0);''><u>#UI Technologies</u></a>.<span class='float-end fs-11 text-muted'>24,Dec 2023 - 14:34</span> </p><p class='text-muted'>Technology id developing rapidly keep up your work 👌</p>", media: [{ img: media26, name: media26 }, { img: media29, name: media29 },], avatarList: [], avatarColor: '' },
            ...
            attachments: [
                { id: 1, img: filemanager1, title: "Full Project", size: "0.45MB", padding: "p-2" },
                { id: 2, img: filemanager3, title: "assets.zip", size: "0.99MB", padding: "" },
                { id: 3, img: filemanager1, title: "image-1.png", size: "245KB", padding: "p-2" },
                { id: 4, img: filemanager3, title: "documentation.zip", size: "2MB", padding: "" },
                { id: 5, img: filemanager3, title: "landing.zip", size: "3.46MB", padding: "" },
            ]
        };
    },
};
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" v-for="(attachment, index) of attachments" :key="index">
                            <div class="d-flex align-items-center flex-wrap gap-2">
                                <div class="lh-1">
                                    <span :class="`avatar avatar-rounded ${attachment.padding} bg-light`">
                                        <img :src="attachment.img" alt="">
                                    </span>
                                </div>
                                <div class="flex-fill">
                                    <a href="javascript:void(0);"><span class="d-block fw-semibold">{{ attachment.title
                                            }}</span></a>
